...
%--------------------------------
\begin{example}
	Consider $\mathbb R_{[0,1]}$ and $\mathbb R^n$ as Euclidean metric spaces. For any $\alpha$, let $f_\alpha : I \to X$ be a continuous and piece-wise smooth injection.
	
	Then, for any $\alpha, \beta$, $f_\alpha [I] \cong f_\beta[I]$.
