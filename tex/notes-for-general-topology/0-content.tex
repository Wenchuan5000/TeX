...
\begin{definition}
	...
	A point $x \in X$ is an \textit{accumulation point} of $u$ iff for any neighbourhood $N$ of $x$, $N$ contains infinitely many terms of $u$; i.e.,
	$$
	\exists k \in \mathbb N: u[\mathbb N_{> k}].
	$$
\end{definition}
%--------------------------------
