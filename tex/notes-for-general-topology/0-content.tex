...
%--------------------------------
\begin{proposition}
	Let $\mathbb X = (X, \mathcal T)$ be a topological space, let $\mathbb A = (A, \mathcal T_A)$ be a subspace of $\mathbb X$, and let $V \subseteq A$ be a closed set in $\mathbb X$.
	
	$V$ is closed in $\mathbb A$ iff there exists a $W \subseteq X$ closed in $\mathbb X$ such that $V = A \cap W$.
