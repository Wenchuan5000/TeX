...
\begin{note}
	If we consider $f$ as an $m$
	$$
	\nabla f =
	\left[
	\begin{matrix}
		\displaystyle \frac{\partial f_1}{\partial x_1} & \cdots & \displaystyle \frac{\partial f_1}{\partial x_m} \\
		\vdots & \ddots & \vdots \\
		\displaystyle \frac{\partial f_n}{\partial x_1} & \cdots & \displaystyle \frac{\partial f_n}{\partial x_m}
	\end{matrix}
	\right].
	$$
\end{note}
