...
% todo: the definition of convergence doesn't have a place to go
%================================
...
\begin{note}
	...
	$$
	\begin{aligned}
		N_x \cap \partial A = (N_x \cap A) \setminus (N_x \cap A^\circ) = N_x \cap A.
	\end{aligned}
	$$
	This implies that $A = \partial A$. Then $A^\circ = A \setminus \partial A = \emptyset$. In this case, $A$ is closed. Assume that $x\notin A$, then we have the same conclusion.
\end{note}
%--------------------------------
