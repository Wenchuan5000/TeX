...
\begin{proposition}
	...
	\begin{proof} \
		\begin{enumerate}[(i)]
			...
			\item
			Let $A$ be a cofinite subset of $X$. $X \setminus A$ is a finite union of singletons. As $(X, \mathcal T)$ is $T_1$, any singletons in $X$ is closed. By Proposition \ref{prop: dark side of topology}, $X \setminus A$ is closed. By Definition \ref{def: closed sets}, $A$ is open.å
		\end{enumerate}
	\end{proof}
\end{proposition}
%--------------------------------
